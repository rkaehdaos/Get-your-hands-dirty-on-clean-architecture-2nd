...
public record ActivityWindow(List<Activity> activities) {
    ...
    public ActivityWindow(Activity... activities) {
        ...
        this(List.of(requireNonNull(activities, "activities must not be null")));
    }
    ...
    /**
     * Calculates the balance for the supplied account by summing matching deposits and withdrawals.
     */
